...
A su vez, definió aspectos como objetivos ( cuadro ~\ref{tab:metas} ), preguntas de investigación ( cuadro~\ref{tab:preguntas} ) y métricas ( cuadro~\ref{tab:metricas} ). Para ello, se siguió el modelo 
